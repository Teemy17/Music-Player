...
class App:
    ...
    def main_window(self):
        ...
        self.btPlay_img = PlayButton(self.window, self, "Images/play.png", 250, 260)
        self.btPause_img = PauseButton(self.window, self, "Images/pause.png", 350, 260)
        self.btStop_img = StopButton(self.window, self, "Images/stop.png", 450, 260)
        self.btNext_img = NextButton(self.window, self, "Images/next.png", 550, 260)
        self.btPrev_img = PrevButton(self.window, self, "Images/prev.png", 150, 260)
        self.btDelete_img = DeleteButton(
            self.window, self, "Images/delete.png", 50, 260, (40, 40)
        )
        self.btAutoPlay_img = AutoPlayButton(
            self.window, self, "Images/autooff.png", 710, 280, (50, 50)
        )
        ...
        self.autoplay_label = Label(
            self.window, text="Autoplay", font=("Arial", 10, "bold"), fg="black"
        ).place(x=700, y=260)
        ...
        self.album_art_label.place(x=30, y=330, width=140, height=140)
